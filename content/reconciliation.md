...
**1.1 Ethereum's share of tokenised RWA value: CONTESTED, do not assert a point figure.** Module A says 58–63% (T5); Module D says ~50% (RWA.xyz, T2); Module E says ~65%. Same quantity, three numbers, differing denominators and methods. The best-tier source supports "largest single share, roughly half." **Rely on that phrasing; retire the 65% and 58–63% from external use.**

**1.2 Total tokenised RWA (the denominator).** A: ~$33.5bn ex-stablecoins; D: "$17.5–36bn" and "$33.5–38bn"; E: "$31–36bn." The same fast-moving figure on different dates and inclusion rules. **Rely on the RWA.xyz ex-stablecoins figure with its exact date, re-pulled at use.**
...
**1.4 BUIDL AUM: CONTESTED.** A: honest "$1.7bn–$2.9bn"; E: "~$2.85bn" as if settled. **Rely on the live RWA.xyz entry, quoted as a range if not pulled fresh.**

**1.5 BUIDL's Ethereum share of its own AUM: genuine conflict.** A: "majority on Ethereum mainnet" (Nov 2025); E caveat: "fell to ~40%." These conflict on direction and cannot both be current. **Contested; do not assert without a fresh per-chain pull.**

**1.6 India bank-channel remittance cost: drifting vintage.** A/C: 12.66% (Q1 2024); E: notes it rose to 14.55% (Q1 2025) and that it is a *global* bank average rather than India-specific. **Rely on the latest RPW issue, labelled "global bank-channel average."**
